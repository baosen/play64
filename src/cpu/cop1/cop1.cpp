...
#include "../interpreter/sext.hpp"
#include "../interpreter/err.hpp"

// The floating-point unit.
namespace {
    INSTR(ctc1) { Fpu::set_ctrl_reg(instr.rd(), get32(instr.rt())); } // rd == fs.
    INSTR(mtc1) { throw err("MTC1 is not implemented yet..."); }
    INSTR(cfc1) { set64(instr.rt(), sext32(Fpu::get64(instr.rd()))); } // rd is same as fs.
    INSTR(mfc1) { set64(instr.rt(), Fpu::get64(instr.rd())); } // rd same as fs.
